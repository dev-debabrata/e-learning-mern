...
const Footer = () => {
    return (
        <footer className=' bg-gray-900 md:px-36 text-left w-full mt-10'>
            <div className=' flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-e-white/30'>
                <div className=' flex flex-col md:items-start items-center w-full'>
                    <h1 className=' text-2xl font-bold text-blue-600 h-10 w-10 lg:w-40 cursor-pointer'>E-Learning</h1>
